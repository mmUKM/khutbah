...
if ( ! function_exists( 'jrwtdw_theme_sidebar' ) ) {
  ...
  function jrwtdw_theme_sidebar() {
    ...
    register_sidebar( array(
      ...
      'before_title'  => '<h2>',
      'after_title'   => '</h2>',
      'before_widget' => '<div class="section wrap group"><div class="col span_12_of_12 frontpage-widget">',
...
if ( ! function_exists( 'jrwtdw_theme_scripts' ) ) {
  ...
  function jrwtdw_theme_scripts() {
    ...
    wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/lib/font-awesome/css/font-awesome.min.css', false, '1.0' );
