...
<div class="wrap section group page">
    <div class="col span_8_of_12 article">
        ...
        <p class="uk-text-meta uk-text-left uk-margin-remove-bottom"><span uk-icon="calendar"></span> <?php the_field('khutbah_podcast_date'); ?></p>
        <p class="uk-text-meta uk-text-left uk-margin-remove"><span uk-icon="user"></span> <?php the_field('khutbah_podcast_khatib'); ?></p>
        ...
        <div class="embed-container">
            <?php the_field('khutbah_podcast_link'); ?>
        </div>
